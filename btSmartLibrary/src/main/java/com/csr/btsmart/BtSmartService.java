...
import com.csr.btsmart.BtSmartRequest.RequestType;
...
public class BtSmartService extends Service {
	...
	public enum BtSmartUuid {
		...
		TX_CHARACTERISTIC("21819AB0-C937-4188-B0DB-B9621E1696CD");
		...
		//RSC_SERVICE("00001814-0000-1000-8000-00805f9b34fb"), Running Speed Cadence
		//RSC_MEASUREMENT("00002a53-0000-1000-8000-00805f9b34fb"),
		//SC_CONTROL_POINT("00002a55-0000-1000-8000-00805f9b34fb"),
		//BP_SERVICE("00001810-0000-1000-8000-00805f9b34fb"), Blood pressure
